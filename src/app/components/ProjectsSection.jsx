...
const projectsData = [
  {
    ...
    title: "RareSense",
    description:
      "Enhancing differential diagnosis with phenotype prioritization",
  ...
  },
  {
    ...
    description:
      "Builds upon the foundational subgraphs of Lido Finance by incorporating optimized GraphQL queries for improved data retrieval",
  ...
  {
    id: 3,
    title: "Long Short-Term Memory (LSTM) model using PyTorch",
    description:
      "Includes visualizations and model evaluation metrics that demonstrate the effectiveness of the LSTM model in predicting Amazon stock prices",
